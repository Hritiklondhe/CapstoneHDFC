package com.hdfc.client.configuration;
...
public class EmployeeConfig {
	...
	public HttpComponentsClientHttpRequestFactory validateSSL() {
		String locationJKS = "E:/HDFC/CapstoneProject/EmployeeManagementSystem/employeeapp/src/main/resources/HDFC_EMP.jks";
		String passwordJKS = "password123";
		SSLContext sslContext = null;
		try {
			sslContext = SSLContextBuilder
					.create()
					.loadTrustMaterial(ResourceUtils.getFile(locationJKS), passwordJKS.toCharArray())
					.build();
		} catch (Exception e) {
